...
void loop() {
 ...
 if( digitalRead(Arranque) ) {    // Prende motores secuencialmente
    ...
    digitalWrite(Motor02, HIGH);  // Enciende Motor 02
    delay(3000);  // Espera

    digitalWrite(Motor03, HIGH);  // Enciende Motor 03
    delay(10);  // Espera
 }       
 ...
 if( digitalRead(Parada) ) {     // Apaga motores secuencialmente
    ...
    digitalWrite(Motor02, LOW);  // Apaga Motor 02
    delay(3000);  // Espera

    digitalWrite(Motor03, LOW);  // Apaga Motor 03
    delay(10);  // Espera
